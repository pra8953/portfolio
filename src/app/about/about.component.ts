   ...
   education = [
    {
      ...
      description:
      'Pursuing Bachelor of Vocation in Software Development from Ramanujan College, University of Delhi. Gained hands-on experience in software engineering principles, full-stack development, and real-world projects. Maintained a strong academic record with a current SGPA of 8.64 in the 3rd semester.',
  },
    {
      year: '2020 - 2023',
      title: 'Higher Secondory School',
      description:
         'Completed 12th with Physics, Chemistry, and Mathematics under the UP Board in 2023. Built a strong foundation in logical reasoning and problem-solving which laid the groundwork for software development and programming.',
    },
  ];
